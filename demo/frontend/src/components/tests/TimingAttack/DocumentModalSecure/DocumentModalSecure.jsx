...
import './DocumentModalSecure.css';

const DocumentModalSecure = ({ document, onClose }) => {
    ...
    const [processingTime] = useState(null);
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8800/api/secure/case5/verify-access', {
                method: 'POST',
                headers: {
            ...
            setUserRole(data.userAccess?.role || 'user');
    ...
    const canChangePermissions = userRole === 'admin';
                        ...
                        <div className="document-actions">
                            {canChangePermissions && (
                                <button
                                    ...
                                    className={`permission-button ${!canChangePermissions ? 'disabled' : ''}`}
                                >
                                    Change Permission
                                </button>
                            )}
...
export default DocumentModalSecure;